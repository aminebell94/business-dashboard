...
function TableFooter({ className, ...props }: React.ComponentProps<'tfoot'>) {
  return (
    <tfoot
      ...
      className={cn(
        'bg-muted/50 border-t border-neutral-200 dark:border-neutral-800 font-medium [&>tr]:last:border-b-0',
        className,
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<'tr'>) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        'border-b border-neutral-200 dark:border-neutral-800 transition-colors duration-200 ease-in-out',
